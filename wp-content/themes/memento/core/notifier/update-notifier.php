...
function update_notifier() { 
    ...
    <div class="wrap">
        ...
        <div id="instructions">
            ...
            <p>To get the latest update of the Theme, go to <a href="http://yithemes.com/themes/wordpress/memento-a-flexible-corporate-wordpress-theme/">Meménto</a> page and re-download the theme like you did the first time.</p>
