...
function yiw_render_field( $option ) {
    ...
    switch( $option['type'] ) {
        ...
        case 'select-icon' : global $yiw_awesome_icons ?>
            <select name="<?php yiw_name_field( $option['id'] ) ?>" id="<?php yiw_id_field( $option['id'] ) ?>">
                <?php foreach( $yiw_awesome_icons as $key => $value ) : ?><option value="<?php echo $key ?>"<?php selected( $key, $db_value ) ?>><?php echo $value ?></option><?php endforeach; ?>
            </select> 
            <span class="description"><?php echo $option['desc'] ?></span>
        <?php
        break;      
...
function yiw_link_documentation() {
	if ( isset( $_GET['page'] ) && $_GET['page'] == 'yiw_panel' && get_option( 'yiw_show_advise_memento_documentation', 'yes' ) == 'yes' ) :
	?>
    <div id="yiw_message" class="updated fade">
    	<p>
			<?php _e( sprintf( 'You can find the documentation at %s.', '<a href="http://yithemes.com/docs-free/memento/index.html">' . __( 'this link', 'yiw' ) . '</a>' ), 'yiw' ) ?><br />
			<?php _e( sprintf( 'If you want download this documentation and see it without any internet connection, you can download it by %s', '<a href="http://yithemes.com/docs-free/documentation-memento.zip">' . __( 'this link', 'yiw' ) . '</a>' ), 'yiw' ) ?><br />
...
function yiw_doc_notice_js() {
    ...
    jQuery(document).ready(function($) {
        var show_doc = '<?php echo get_option( 'yiw_show_advise_memento_documentation', 'yes' ); ?>';
        if( show_doc == 'no' )
            { $( '#yiw_message' ).hide(); }
...
function doc_notice_callback() {
	...
	if ( isset( $_POST['yiw_show_advise_memento'] ) && !$_POST['yiw_show_advise_memento'] ) {
	    update_option( 'yiw_show_advise_memento_documentation', 'no' );
	    $_show = 'no';
	} else {	
		$_show = get_option( 'yiw_show_advise_memento_documentation', 'yes' );
	}
