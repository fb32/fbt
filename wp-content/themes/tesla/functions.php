...
class Tesla_twitter_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $user = empty($instance['user']) ? 'winithemes' : $instance['user'];
        ...
        if (!empty($title))
            echo $before_title . $title . $after_title;
        ?>
        <div class="widgetBody widgetTwitter" data-user="<?php echo $user; ?>" data-posts="<?php echo $number; ?>"></div>
        <?php
        echo $after_widget;
    }
    ...
    function form($instance) {
        ...
        $user = isset($instance['user']) ? esc_attr($instance['user']) : 'winithemes';
...
class Tesla_flickr_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $user = empty($instance['user']) ? '94243637@N03' : $instance['user'];
        if (empty($instance['number']) || !$number = absint($instance['number']))
            $number = 12;
    ...
    function form($instance) {
        $instance = wp_parse_args((array) $instance, array('title' => ''));
        $title = isset($instance['title']) ? esc_attr($instance['title']) : '';
        $user = isset($instance['user']) ? esc_attr($instance['user']) : '94243637@N03';
