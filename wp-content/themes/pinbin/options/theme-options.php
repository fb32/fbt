	...
	?>
		...
		<div class="wrap">
			...
			<form id="form-pinbin-options" action="options.php" method="post" enctype="multipart/form-data">
				...
				<p class="submit">
					<input name="theme_pinbin_options[submit]" id="submit_options_form" type="submit" class="button-primary" value="<?php esc_attr_e('Save Settings', 'pinbin'); ?>" />
					<input name="theme_pinbin_options[reset]" type="submit" class="button-secondary" value="<?php esc_attr_e('Reset Default', 'pinbin'); ?>" />		
				</p>
...
add_action('admin_enqueue_scripts', 'pinbin_options_enqueue_scripts');
